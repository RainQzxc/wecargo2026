  ...
  return (
    <div className="space-y-6">
      ...
      <form method="GET" className="flex flex-wrap gap-3 items-end bg-white border border-neutral-200 rounded-xl p-4">
        ...
        {(q || status) && <a href="/dashboard/admin/parcels" className="px-4 py-2 rounded-lg border border-neutral-200 text-ink-3 text-sm font-semibold hover:bg-neutral-50 transition-colors">Цэвэрлэх</a>}
      </form>
