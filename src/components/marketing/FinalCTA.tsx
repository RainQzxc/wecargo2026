        ...
        <div className="mx-auto max-w-4xl overflow-hidden rounded-[28px] border border-[#e5e5e5] bg-white shadow-[0_24px_80px_rgba(17,17,17,0.08)]">
          <div className="grid gap-0 lg:grid-cols-[1fr_auto]">
            <div className="p-6 text-center sm:p-8 lg:p-10 lg:text-left">
              <div className="mb-5 inline-flex items-center gap-2 rounded-full bg-[#06bbb4]/10 px-3 py-1.5 text-xs font-semibold text-[#06bbb4]">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-[#6e6e73] sm:text-lg lg:mx-0">
              ...
              <div className="mt-8 flex justify-center lg:justify-start">
                <Link
                  href="/guide"
                  className="inline-flex min-h-13 items-center justify-center gap-2 rounded-xl bg-[#fe0000] px-7 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#fe0000]/90 focus:outline-none focus:ring-2 focus:ring-[#fe0000]/30 focus:ring-offset-2"
                >
                  Линк холбох заавар
                  <svg
                    className="h-4 w-4"
            ...
            <div className="relative hidden min-h-full w-64 overflow-hidden border-l border-[#e5e5e5] bg-[#1d1d1f] p-6 lg:block">
              ...
              <div className="relative flex h-full flex-col justify-between">
                <p className="text-xs font-semibold text-white/45">Хурдан холбоос</p>
                <nav className="space-y-2">
                  {[
                    ["Ачаагаа хянах", "/track"],
                    ["Тарифтай танилцах", "/pricing"],
                    ["Бидэнтэй холбогдох", "/contact"],
                  ].map(([label, href]) => (
                    <Link
                      key={href}
                      href={href}
                      className="flex items-center justify-between rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm font-semibold text-white transition-colors hover:border-[#06bbb4]/40 hover:bg-white/10"
                    >
                      {label}
                      <svg
